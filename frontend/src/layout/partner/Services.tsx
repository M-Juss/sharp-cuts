    ...
    <div className="lg:col-span-3 col-span-1 flex flex-col">
      ...
      <div className="flex flex-col bg-white rounded-xl shadow-md border border-gray-200 p-4 my-4 ">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            onClick={onAddClick}
            className="flex gap-1 py-2 px-3  bg-manager text-white rounded-md "
          >
            {' '}
            <Plus /> Add
          </button>
        ...
        <div className="grid grid-cols-1 gap-2 ">
          {services.map((service, index) => (
            <div key={index} className="flex justify-between items-center w-full p-4  bg-white rounded-xl border border-gray-200 hover:bg-gray-100 transition ease-in">
